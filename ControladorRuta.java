...
public class ControladorRuta {
    ...
    {
    	if(!ExisteRuta(id)) throw new Exception("No existe ninguna ruta con ese identificador");
    ...
    public void ModificarIddRuta(int id_original, int id_nuevo) throws Exception
    {
        ...
        if(ExisteRuta(id_nuevo)) throw new Exception("Ya existe una ruta con ese identificador");
