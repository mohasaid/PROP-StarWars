...
public class TipoNave5 extends Nave{
	...
	/**
	 * metodo que define el tipo de nave 5 asignandole un consumo
	 * @param c
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public TipoNave5(int id,String d,String o) throws Exception{
		...
		if(!definido){
			throw new Exception("Error: el tipo de nave 5 no ha sido definido\n");
		}
		ident =id;
		destino = d;
		origen = o;
