...
public class TipoNave4 extends Nave{
	...
	//pre:cierto
	//post: el tipo de nave 4 queda definido pasando a tener consumo c asignado
	/**
	 * metodo que define el tipo de nave 4 asignandole un consumo
	 * @param c
	 * @throws Exception
	 */
	...
	//pre:cierto;
	//Post: Crea una nave de tipo 4 a partir de una nave sin tipo
	/**
	 * metodo que crea una nave de tipo 4 a partir de una nave sin tipo
	 * @param n
	 * @throws Exception
	 */
	...
	/**
	 * metodo que crea una nave de tipo 4 con identificador, destino y origen
	 * @param id
	 * @param d
	 * @param o
	 * @throws Exception
	...
	/**
	 * metodo que crea consulta si el tipo 4 está definido
	 */
	...
	/**
	 * metodo que consulta el consumo asociado al tipo de nave 4
	 * @throws Exception
	 */
	...
	/**
	 * metodo que modifica el consumo asociado al tipo de nave 4
	 * @param c
	 * @throws Exception
	 */
