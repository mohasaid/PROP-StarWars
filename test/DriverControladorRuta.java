public class DriverControladorRuta {
    ...
    public void Executa(ControladorRuta cr, ControladorPlaneta cp, Scanner cin) throws Exception {
        ...
        while (n != 0) {
            switch (n) {
                case 1:
                    TestControladorCrearRuta(cin, cr, cp);
                    break;
                case 2:
                    TestControladorCrearRutaAutomatica1(cr, cp);
                    break;
                case 3:
                    TestControladorCrearRutaAutomatica2(cin, cr, cp);
                    break;

                case 4:
                    TestControladorConsultarCpacitatRuta(cin, cr);
                    break;
                case 5:
                    TestControladorConsultarDistanciaRuta(cin, cr);
                    break;
                case 6:
                    TestControladorConsultarPlanetaARuta(cin, cr);
                    break;
                case 7:
                    TestControladorConsultarPlanetaBRuta(cin, cr);
                    break;
                case 8:
                    TestControladorConsultar_numero_rutes(cr);
                    break;
                case 9:
                    TestConsultar_arbre_conexions(cr);
                    break;
                case 10:
                    TestControladorConsultar_entrades_planeta(cin, cr);
                    break;
                case 11:
                    TestControladorConsultar_sortides_planeta(cin, cr);
                    break;
                case 12:
                    TestControladorConsultar_ids_rutas(cr);
                    break;
                case 13:
                    TestControladorExisteConexion(cin, cr);
                    break;
                case 14:
                    TestControladorConsultarExisteRuta(cin, cr);
                    break;
                case 15:
                    TestControladorBuscarConexion(cin, cr);
                    break;
                case 16:
                    TestControladorBuscarRuta(cin, cr);
                    break;
                case 17:
                    TestControladorConsultarConexiones(cr);
                    break;
                case 18:
                    TestConsultaridruta(cin, cr);
                    break;

                case 19:
                    TestControladorModificarCpacitatRuta(cin, cr);
                    break;
                case 20:
                    TestControladorModificarDistanciaRuta(cin, cr);
                    break;
                case 21:
                    TestControladorModificarPlanetaARuta(cin, cr, cp);
                    break;
                case 22:
                    TestControladorModificarPlanetaBRuta(cin, cr, cp);
                    break;


                case 23:
                    TestControladorBorrarRutaConexions_desdePlaneta(cin, cr);
                    break;
                case 24:
                    TestControladorBorrarRuta(cin, cr, cp);
                    break;
                case 25:
                    TestControladorBorrarTodasRutas(cin, cr);
                    break;

                case 26:
                    TestControladorCargarRutas(cin, cr, cp);
                    break;
                case 27:
                    TestControladorGuardarRutas(cin, cr);
                    break;
                default:
