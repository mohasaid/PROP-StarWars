public class DriverControladorPlaneta {
    ...
    public void Ejecuta(Scanner sc, ControladorPlaneta cp, ControladorRuta cr, ControladorGalaxia cg) {
        ...
        while (n != 0) {
            switch (n) {
                case 1:
                    TestCrearPlaneta(sc, cp, cg);
                    break;
                case 2:
                    TestCrearPlanetaAuto(cp, cg);
                    break;
                case 3:
                    TestCrearPlanetaAuto2(sc, cp, cg);
                    break;
                case 4:
                    TestConsultarCoste(sc, cp);
                    break;
                case 5:
                    TestConsultarCoordenadas(sc, cp);
                    break;
                case 6:
                    TestConsultarCoordenadaX(sc, cp);
                    break;
                case 7:
                    TestConsultarCoordenadaY(sc, cp);
                    break;
                case 8:
                    TestConsultarlistaPlaneta(cp);
                    break;
                case 9:
                    TestModificarCoste(sc, cp);
                    break;
                case 10:
                    TestModificarCoordenadas(sc, cp, cg);
                    break;
                case 11:
                    TestBorrar(sc, cp, cr, cg);
                    break;
                case 12:
                    TestCargar(sc, cp, cg);
                    break;
