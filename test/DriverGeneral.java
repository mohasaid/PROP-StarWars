        ...
        while (op != 0) {
            switch (op) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    DCGalaxia.Executa(sc, cp, cr, cn, cg);
                    break;
                case 5:
                    DCRuta.Executa(cr, cp, sc);
                    break;
                case 6:
                    DRuta.Executa(sc);
                    break;
                case 7:
                    DCP.Ejecuta(sc, cp, cr, cg);
                    break;
                case 8:
                    Dp.Ejecuta(sc);
                    break;
                ...
                case 11:
                    ...
                    break;
                case 12:
                    Dsalida.Executa(sc, cr, cg);
                    break;
                case 13:
                    dMFP.Executa(sc, cMFP, cg, cr, cp, cn);
                    break;
                case 14:
                    dp.Executa(sc);
                    break;
