...
public class DriverControladorMFP {
    public void Executa(Scanner sc, ControladorMFP cMFP, ControladorGalaxia cg, ControladorRuta cr, ControladorPlaneta cp, ControladorNave cn) {
        ...
        while (op != 0) {
            switch (op) {
                case 1:
                    TestSeleccionarFC(sc, cMFP, cg, cr, cp, cn);
                    break;
                case 2:
                    TestSeleccionarAlgoritmo(sc, cMFP, cn, cr, cp);
                    break;
                case 3:
                    TestConsultarSalida(cMFP);
                    break;
                case 4:
                    TestConsultarCambios(cMFP);
                    break;
                case 5:
                    TestEjecutarAlgoritmo(cMFP, cn, cr, cp);
                    break;
                default:
