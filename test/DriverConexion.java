public class DriverConexion {
    ...
    public void Executa(Scanner cin) throws Exception {
        ...
        while (n != 0) {
            switch (n) {
                case 1:
                    TestCrearConnexio2(cin);
                    break;
                case 2:
                    TestConsultarIdConnexio();
                    break;
                case 3:
                    TestConsultarPlanetaAConnexio();
                    break;
                case 4:
                    TestConsultarPlanetaBConnexio();
                    break;
                case 5:
                    TestModificarIdConnexio(cin);
                    break;
                case 6:
                    TestModificarPlanetaAConnexio(cin);
                    break;
                case 7:
                    TestModificarPlanetaBConnexio(cin);
                    break;
                default:
