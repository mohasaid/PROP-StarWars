...
public class DriverControladorGalaxia {
    ...
    public void Executa(Scanner cin, ControladorPlaneta cp, ControladorRuta cr, ControladorNave cn, ControladorGalaxia cGalaxia) {
        ...
        while (n != 0) {
            switch (n) {
                ...
                case 1:
                    TestCrearGalaxia(cin, cGalaxia);
                    break;
                case 2:
                    TestCrearGalaxia2(cin, cGalaxia);
                    break;

                case 3:
                    TestConsultarNom(cGalaxia);
                    break;
                case 4:
                    TestConsultarLimitsGalaxia(cGalaxia);
                    break;
                case 5:
                    TestConsultarNombreLimits(cGalaxia);
                    break;
                case 6:
                    TestConsultarLimit(cGalaxia);
                    break;
                case 7:
                    TestdintreLimitUsuari(cin, cGalaxia);
                    break;

                case 8:
                    TestmodificarNom(cin, cGalaxia);
                    break;
                case 9:
                    TestmodificarLimit(cin, cGalaxia);
                    break;
                case 10:
                    TestmodificarLimits(cin, cGalaxia);
                    break;

                case 11:
                    TestexisteixPlanetaCoordenades(cin, cGalaxia);
                    break;
                case 12:
                    TestmodificarCoordenadas(cin, cp, cGalaxia);
                    break;
                case 13:
                    TestAlgunPlaneta(cGalaxia);
                    break;

                case 14:
                    TestConsultarPlaneta(cin, cp, cGalaxia);
                    break;

                case 15:
                    TestafegirPlaneta(cp, cin, cGalaxia);
                    break;
                case 16:
                    TestafegirPlanetaAutomatic(cp, cin, cGalaxia);
                    break;
                case 17:
                    TestAfegirPlanetaNIDAuto(cp, cGalaxia);
                    break;
                case 18:
                    TesteliminarPlaneta(cp, cGalaxia, cin);
                    break;
                case 19:
                    TesteliminarPlanetes(cp, cGalaxia);
                    break;

                case 20:
                    TestcarregarConjuntGalaxia(cGalaxia, cp, cin);
                    break;
                case 21:
                    TestguardarConjuntGalaxia(cGalaxia, cin);
                    break;

                case 22:
                    TestconsultarGrafo(cin, cGalaxia, cr, cp, cn);
                    break;
    ...
    public void TestdintreLimitUsuari(Scanner cin, ControladorGalaxia cGalaxia) {
        try {
            ...
            if (cGalaxia.consultarNombreLimits() > 0) {
                ...
                if ((cGalaxia.consultarLimit() > x && x > 0) && (cGalaxia.consultarLimit() > y && y > 0))
                    System.out.println("Si que esta dins el limit");
                else System.out.println("No esta dins el limit");
            }
        } catch (Exception e) {
            System.out.println(e);
    ...
    public void TestmodificarLimits(Scanner cin, ControladorGalaxia cGalaxia) {
        try {
            ...
            pa_f = cin.nextInt();
            if (pa_f > cGalaxia.consultarLimit() || pa_f < 0)
                throw new Exception("Las coordenadas no pueden ser ni mayores que el limite maximo de la galaxia ni menores que 0");
            pa_s = cin.nextInt();
            if (pa_s > cGalaxia.consultarLimit() || pa_s < 0)
                throw new Exception("Las coordenadas no pueden ser ni mayores que el limite maximo de la galaxia ni menores que 0");
