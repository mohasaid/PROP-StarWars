...
public class DriverGalaxia {
    ...
    public void Executa(Scanner cin) {
        ...
        while (opcion != 0) {
            switch (opcion) {
                case 1:
                    g = TestCrearGalaxia(cin);
                    break;
                case 2:
                    g = TestCrearGalaxia1(cin);
                    break;

                case 3:
                    TestConsultarNomGalaxia(g);
                    break;
                case 4:
                    Testconsulta_nombreLimits(g);
                    break;
                case 5:
                    TestconsultaLimitsUsuari(g);
                    break;
                case 6:
                    TestconsultarLimitGalaxia(g);
                    break;
                case 7:
                    TestdintreLimitUsuari(g, cin);
                    break;

                case 8:
                    Testmodificar_nomGalaxia(g, cin);
                    break;
                case 9:
                    TestmodificarN(g, cin);
                    break;
                case 10:
                    TestmodificarLimits(g, cin);
                    break;

                case 11:
                    TestexisteixPlanetaCoordenades(g, cin);
                    break;
                case 12:
                    TestconsultarPlaneta(g, cin, cp);
                    break;
                case 13:
                    TestalgunPlaneta(g);
                    break;
                ...
                case 14:
                    TestCrearafegirPlaneta(g, cin, cp);
                    break;
                case 15:
                    TestCrearPlanetaAutomaticID(g, cin, cp);
                    break;
                case 16:
                    TestPlanetaAuto(g, cp);
                    break;

                case 17:
                    TesteliminarPLaneta(g, cin, cp);
                    break;
                case 18:
                    TesteliminarTotsPlanetes(g, cp);
                    break;
                default:
    ...
    private static void TestdintreLimitUsuari(Galaxia g, Scanner cin) {
        ...
        try {
            ...
            if (g.consulta_nombreLimits() > 0) {
                ...
                if ((g.consultarLimitGalaxia() > x && x > 0) && (g.consultarLimitGalaxia() > y && y > 0))
    ...
    private static void TestmodificarLimits(Galaxia g, Scanner cin) {
        try {
            ...
            pa_f = cin.nextInt();
            if (pa_f > g.consultarLimitGalaxia() || pa_f < 0)
                throw new Exception("Las coordenadas no pueden ser ni mayores que el limite maximo de la galaxia ni menores que 0");
            pa_s = cin.nextInt();
            if (pa_s > g.consultarLimitGalaxia() || pa_s < 0)
                throw new Exception("Las coordenadas no pueden ser ni mayores que el limite maximo de la galaxia ni menores que 0");
            ...
            int l1 = cin.nextInt();
            if (l1 > g.consultarLimitGalaxia() || l1 < 0)
                throw new Exception("Las coordenadas no pueden ser ni mayores que el limite maximo de la galaxia ni menores que 0");
            int l2 = cin.nextInt();
            if (l2 > g.consultarLimitGalaxia() || l2 < 0)
                throw new Exception("Las coordenadas no pueden ser ni mayores que el limite maximo de la galaxia ni menores que 0");
